...
calls = [
    hwModel.couponBondOption(exercise, payTimes, cashFlows, strike, 1.0)
...
callPayoffs = [
    Payoffs.Pay(Payoffs.VanillaOption(bondPayoff, strike, 1.0), exercise)
    for strike in mcStrikes
]
putPayoffs = [
    Payoffs.Pay(Payoffs.VanillaOption(bondPayoff, strike, -1.0), exercise)
    for strike in mcStrikes
