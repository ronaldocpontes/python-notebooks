...
from QuantLibWrapper import (
    HullWhiteModel,
    MCSimulation,
    Payoffs,
    BermudanOption,
    DensityIntegrationWithBreakEven,
    SimpsonIntegration,
    HermiteIntegration,
...
hwModel = HullWhiteModelWithDiscreteNumeraire(
    fwdRateYC, meanReversion, volatilityTimes, volatilityValues
)
...
print(
    "Bond option with zero strike: "
    + str(hwModel.couponBondOption(exercise, payTimes, cashFlows, 0.0, 1.0))
)
print(
    "Bond option with unit strike: "
    + str(hwModel.couponBondOption(exercise, payTimes[1:], cashFlows[1:], 1.0, 1.0))
)
